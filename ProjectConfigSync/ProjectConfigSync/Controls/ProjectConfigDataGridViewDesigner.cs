...
//{
//    internal class ProjectConfigDataGridViewDesigner : ControlDesigner
//    {
...
//        /// <devdoc>
//        /// <para>Initializes a new instance of the <see cref="System.Windows.Forms.Design.DataGridViewDesigner"> class.</see></para>
//        /// </devdoc> 
//        public ProjectConfigDataGridViewDesigner()
//        {
...
//            set
//            {
//                // [....]: this is a workaround for a bug in ComponentCache: if a component changed then its list of AssociatedComponents 
...
//                    designerVerbs.Add(new DesignerVerb(SR.GetString(SR.DataGridViewEditColumnsVerb), new EventHandler(this.OnEditColumns)));
//                    designerVerbs.Add(new DesignerVerb(SR.GetString(SR.DataGridViewAddColumnVerb), new EventHandler(this.OnAddColumn)));
//                }
...
//                if (prop != null)
//                {
//                    properties[shadowProps[i]] = TypeDescriptor.CreateProperty(typeof(ProjectConfigDataGridViewDesigner), prop, empty);
//                }
//            }
//        }
...
//                {
//                    throw new InvalidOperationException(SR.GetString(SR.DataGridViewDataSourceNoLongerValid), ex);
//                }
...
//            DataGridViewColumnCollectionDialog dialog = new DataGridViewColumnCollectionDialog();
//            dialog.SetLiveDataGridView((DataGridView)this.Component);

//            DesignerTransaction transaction = host.CreateTransaction(SR.GetString(SR.DataGridViewEditColumnsTransactionString));
...
//            DesignerTransaction transaction = host.CreateTransaction(SR.GetString(SR.DataGridViewAddColumnTransactionString));

//            DialogResult result = DialogResult.Cancel;

//            DataGridViewAddColumnDialog dialog = new DataGridViewAddColumnDialog(((DataGridView)this.Component).Columns, (DataGridView)this.Component);
...
//        {
//            ProjectConfigDataGridViewDesigner owner;

//            public DataGridViewChooseDataSourceActionList(ProjectConfigDataGridViewDesigner owner)
...
//                                                                                             SR.GetString(SR.DataGridViewChooseDataSource));// displayName
...
//                    DesignerTransaction transaction = host.CreateTransaction(SR.GetString(SR.DataGridViewChooseDataSourceTransactionString, dataGridView.Name));
//                    try
//                    {
...
//        {
//            ProjectConfigDataGridViewDesigner owner;
//            public DataGridViewColumnEditingActionList(ProjectConfigDataGridViewDesigner owner)
//                : base(owner.Component)
//            {
//                this.owner = owner;
//            }
...
//                                                                                    SR.GetString(SR.DataGridViewEditColumnsVerb),   // display name
//                                                                                    true));                                          // promoteToDesignerVerb
//                items.Add(new DesignerActionMethodItem(this,
//                                                                                   "AddColumn",                                     // method name
//                                                                                   SR.GetString(SR.DataGridViewAddColumnVerb),      // display name 
//                                                                                   true));                                           // promoteToDesignerVerb 
...
//            public DataGridViewPropertiesActionList(ProjectConfigDataGridViewDesigner owner)
//                : base(owner.Component)
//            {
//                this.owner = owner;
//            }
...
//                        if (value)
//                        {
//                            transaction = host.CreateTransaction(SR.GetString(SR.DataGridViewEnableAddingTransactionString));
//                        }
//                        else
//                        {
//                            transaction = host.CreateTransaction(SR.GetString(SR.DataGridViewDisableAddingTransactionString));
//                        }
//                        try
//                        {
//                            IComponentChangeService changeService = this.owner.Component.Site.GetService(typeof(IComponentChangeService)) as IComponentChangeService;
...
//                        if (value)
//                        {
//                            transaction = host.CreateTransaction(SR.GetString(SR.DataGridViewEnableDeletingTransactionString));
//                        }
//                        else
//                        {
//                            transaction = host.CreateTransaction(SR.GetString(SR.DataGridViewDisableDeletingTransactionString));
//                        }
//                        try
//                        {
//                            IComponentChangeService changeService = this.owner.Component.Site.GetService(typeof(IComponentChangeService)) as IComponentChangeService;
...
//                        if (value)
//                        {
//                            transaction = host.CreateTransaction(SR.GetString(SR.DataGridViewEnableColumnReorderingTransactionString));
//                        }
//                        else
//                        {
//                            transaction = host.CreateTransaction(SR.GetString(SR.DataGridViewDisableColumnReorderingTransactionString));
//                        }
//                        try
//                        {
//                            IComponentChangeService changeService = this.owner.Component.Site.GetService(typeof(IComponentChangeService)) as IComponentChangeService;
...
//                        if (value)
//                        {
//                            transaction = host.CreateTransaction(SR.GetString(SR.DataGridViewEnableEditingTransactionString));
//                        }
//                        else
//                        {
//                            transaction = host.CreateTransaction(SR.GetString(SR.DataGridViewDisableEditingTransactionString));
//                        }
//                        try
//                        {
//                            IComponentChangeService changeService = this.owner.Component.Site.GetService(typeof(IComponentChangeService)) as IComponentChangeService;
